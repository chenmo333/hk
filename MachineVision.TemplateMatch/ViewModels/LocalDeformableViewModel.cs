...
{
    internal class LocalDeformableViewModel : NavigationViewModel
    {
        public LocalDeformableViewModel()
        { 
            MatchService = ContainerLocator.Current.Resolve<ITemplateMatchService>(nameof(TempalteMatchType.LocalDeformable));
